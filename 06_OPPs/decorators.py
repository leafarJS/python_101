...
Decoradores:
-----------
Se utilizan para implementar un comportamiento particular para nuestras clases.

Resumen:
--------
1. propiedad: actúa como una variable de instancia, no es necesario llamar a una función similar.
2. método estático: llamado directamente desde la clase.
3. método de clase: devuelve una nueva instancia de la clase.
4. getter & setter: se utiliza para `encapsulación de datos`.

Información:
-----
Podemos marcar la clase como `final` para que ninguna otra clase pueda subclasificarla.
"""
